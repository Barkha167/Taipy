...
def toggle_sidebar(state: State) -> None:
...
page = """
<|layout|columns={200 if show_sidebar else 0}px 1|  <!-- Adjusts width dynamically based on sidebar visibility -->
<|part|class_name=sidebar|visible={show_sidebar}|
...
<|Hide Sidebar|button|on_action=toggle_sidebar|class_name=fullwidth mt1|>
"""
